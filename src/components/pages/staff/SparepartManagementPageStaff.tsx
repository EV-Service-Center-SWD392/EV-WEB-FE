...
function SparepartManagementPageStaff() {
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
              ...
              Xem thông tin phụ tùng EV
            </h1>
            <p className="text-gray-600 mt-2">
              Xem dữ liệu phụ tùng, dự báo và yêu cầu bổ sung (Chế độ chỉ xem)
            </p>
          </div>
...
export default SparepartManagementPageStaff;
